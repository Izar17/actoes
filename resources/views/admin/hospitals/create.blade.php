    ...
    <div class="card-body">
        <form method="POST" action="{{ route('admin.hospitals.store') }}" enctype="multipart/form-data">
            ...
            <div class="row my-3">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('expiry') ? 'is-invalid' : '' }}" type="date" name="expiry" id="expiry" required>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('license_no') ? 'is-invalid' : '' }}" type="text" name="license_no" id="license_no" required>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('rhso') ? 'is-invalid' : '' }}" type="text" name="rhso" id="rhso" required>
                        @if($errors->has('rhso'))
                            <div class="invalid-feedback">
                                {{ $errors->first('rhso') }}
                            </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('contact_no') ? 'is-invalid' : '' }}" type="text" name="contact_no" id="contact_no" required>
            ...
            <div class="row my-3">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('rep') ? 'is-invalid' : '' }}" type="text" name="rep" id="rep" required>
                        @if($errors->has('rep'))
                            <div class="invalid-feedback">
                                {{ $errors->first('rep') }}
                            </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label class="required" for="created_by">{{ trans('cruds.hospital.fields.created_by') }}</label>
                        <input class="form-control {{ $errors->has('created_by') ? 'is-invalid' : '' }}" type="text" name="created_by" value="{{ old('email', auth()->user()->email) }}" id="created_by" readonly>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('date') ? 'is-invalid' : '' }}" type="text" name="date" id="date" value="{{ now()->format('Y-m-d') }}" readonly>
                        @if($errors->has('date'))
                            <div class="invalid-feedback">
                                {{ $errors->first('date') }}
                            </div>
            ...
            <div class="row my-3">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('airline') ? 'is-invalid' : '' }}" type="text" name="airline" id="airline" required>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label class="required" for="airline_etd">{{ trans('cruds.hospital.fields.airline_etd') }}</label>
                        <input class="form-control {{ $errors->has('airline_etd') ? 'is-invalid' : '' }}" type="text" name="airline_etd" id="airline_etd" required>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label class="required" for="airline_eta">{{ trans('cruds.hospital.fields.airline_eta') }}</label>
                        <input class="form-control {{ $errors->has('airline_eta') ? 'is-invalid' : '' }}" type="text" name="airline_eta" id="airline_eta" required>
            ...
            <div class="row my-3">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('vessel') ? 'is-invalid' : '' }}" type="text" name="vessel" id="vessel" required>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label class="required" for="vessel_etd">{{ trans('cruds.hospital.fields.vessel_etd') }}</label>
                        <input class="form-control {{ $errors->has('vessel_etd') ? 'is-invalid' : '' }}" type="text" name="vessel_etd" id="vessel_etd" required>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label class="required" for="vessel_eta">{{ trans('cruds.hospital.fields.vessel_eta') }}</label>
                        <input class="form-control {{ $errors->has('vessel_eta') ? 'is-invalid' : '' }}" type="text" name="vessel_eta" id="vessel_eta" required>
            ...
            <div class="row my-3">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('stowage') ? 'is-invalid' : '' }}" type="text" name="stowage" id="stowage" required>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('rigging') ? 'is-invalid' : '' }}" type="text" name="rigging" id="rigging" required>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('placards') ? 'is-invalid' : '' }}" type="text" name="placards" id="placards" required>
            ...
            <div class="row my-3">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('vehicle') ? 'is-invalid' : '' }}" type="text" name="vehicle" id="vehicle" required>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label class="required" for="vehicle_plate">{{ trans('cruds.hospital.fields.vehicle_plate') }}</label>
                        <input class="form-control {{ $errors->has('vehicle_plate') ? 'is-invalid' : '' }}" type="text" name="vehicle_plate" id="vehicle_plate" required>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label class="required" for="vehicle_etd">{{ trans('cruds.hospital.fields.vehicle_etd') }}</label>
                        <input class="form-control {{ $errors->has('vehicle_etd') ? 'is-invalid' : '' }}" type="text" name="vehicle_etd" id="vehicle_etd" required>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label class="required" for="vehicle_eta">{{ trans('cruds.hospital.fields.vehicle_eta') }}</label>
                        <input class="form-control {{ $errors->has('vehicle_eta') ? 'is-invalid' : '' }}" type="text" name="vehicle_eta" id="vehicle_eta" required>
            ...
            <div class="row my-3">
                <div class="col-md-3">
                    <div class="form-group">
                        <label class="required" for="forwarder">{{ trans('cruds.hospital.fields.forwarder') }}</label>
                        <input class="form-control {{ $errors->has('forwarder') ? 'is-invalid' : '' }}" type="text" name="forwarder" id="forwarder" required>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label class="required" for="forwarder_plate">{{ trans('cruds.hospital.fields.forwarder_plate') }}</label>
                        <input class="form-control {{ $errors->has('forwarder_plate') ? 'is-invalid' : '' }}" type="text" name="forwarder_plate" id="forwarder_plate" required>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label class="required" for="forwarder_etd">{{ trans('cruds.hospital.fields.forwarder_etd') }}</label>
                        <input class="form-control {{ $errors->has('forwarder_etd') ? 'is-invalid' : '' }}" type="text" name="forwarder_etd" id="forwarder_etd" required>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label class="required" for="forwarder_eta">{{ trans('cruds.hospital.fields.forwarder_eta') }}</label>
                        <input class="form-control {{ $errors->has('forwarder_eta') ? 'is-invalid' : '' }}" type="text" name="forwarder_eta" id="forwarder_eta" required>
