@foreach ($transactions as $key => $transaction)
    ...
    @if ($transaction->asset_id == 1 || $transaction->asset_id == 3)
        <table align="center" width="98%" border="0">
            ...
            <tr>
                ...
                <td width="22%" align="left" scope="col"><b>{{ $transaction->asset->name ?? '' }}</b></td>
                <td width="19%" scope="col"><b>&nbsp;&nbsp;{{ $transaction->particular ?? '' }} </b><b
                        style="font-size:12px; color:#f00; ">({{ $transaction->activity_mbq ?? '' }} MBq)</b></td>
                ...
                <td width="18%" scope="col">
                    <b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ $transaction->particular ?? '' }}</b><b
                        style="font-size:12px; color:#f00; ">({{ $transaction->activity_mbq ?? '' }} MBq)</b>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td scope="col" style="font-size:14px;"><b>&nbsp;&nbsp;&nbsp;{{ $transaction->patient ?? '' }}</b>
                </td>
            ...
            <tr>
                ...
                <td scope="col" style="font-size:14px;">
                    <b>&nbsp;&nbsp;&nbsp;{{ $transaction->particular ?? '' }}</b><b
                        style="font-size:14px; color:#f00; ">({{ $transaction->activity_mbq ?? '' }} MBq)</b>
                </td>
                <td scope="col" style="font-size:14px;">
            ...
            <tr>
                ...
                <td scope="col" style="font-size:14px;"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        {{ $transaction->expiry_date ?? '' }}&nbsp;{{ $transaction->expiry_time ?? '' }}</b></td>
                <td scope="col">&nbsp;</td>
                <td scope="col" style="font-size:14px;">
                    <b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ $transaction->procedure1 ?? '' }}</b>
                </td>
    ...
    @elseif($transaction->asset_id == 2)
        <table width="43%" height="118" border="0" align="center" data-entry-id="{{ $transaction->id }}">
            <tr>
                <td height="19" colspan="2" align="left" style="font-size:11px; " scope="col"><b>Sodium
                        Iodide, Na 131
                        I</b></td>
                <td width="15%" rowspan="2" align="right" style="font-size:12px; " scope="col"><img
                        src="{{ asset('img/nuclear_logo.jpg') }}" alt="Image" width="38" height="28" />
                </td>
            </tr>
            <tr>
                <td height="19" colspan="2" align="left" style="font-size:10px;font-weight:normal;">
                    Hospital:&nbsp;&nbsp;<b><u>{{ $transaction->hospital->hospital ?? '' }}</u></b></td>
            </tr>
            <tr>
                <td width="55%" height="19" align="left" style="font-size:10px;font-weight:normal;">
