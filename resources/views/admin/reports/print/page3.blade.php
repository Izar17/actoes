                ...
                @else
                    ...
                    @foreach ($transactions as $key => $transaction)
                        <tr>
                            ...
                            <td align="center" style="font-size:12px; color:#f00; ">
                                <strong>{{ $transaction->activity_mbq ?? '' }}</strong></td>
                            <td width="52" align="center">{{ $transaction->actual_dose ?? '' }}</td>
                            <td align="center" style="font-size:12px; color:#f00; ">
                                <strong>{{ $transaction->actual_mbq ?? '' }}</strong></td>
                        </tr>
                    @endforeach
                @endif
            </table><BR />
            <p align="center" style="font-size:14px;"><strong>RADIOACTIVE MATERIAL, TYPE A PACKAGE, NORMAL FROM, CLASS
                    7,
